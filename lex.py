...
def detect_keyword(group_lex):
	"""
	To detect keywords
	"""
	temp_group_lex = group_lex.copy()
	for i, arr in enumerate(group_lex):
		for reserved_word in c_reserved_words:
			if reserved_word[0] == arr['word']:
				temp_group_lex[i]['type'] = reserved_word[1]
				break
